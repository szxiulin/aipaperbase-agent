...
- `organization.py`: refresh-safe explicit-assignment and evidence-backed classification drafts, followed by confirmed transactional writes;
...
- `organization.py`：可刷新恢复的指定加入与有依据智能分类草稿，以及确认后的事务写入；
