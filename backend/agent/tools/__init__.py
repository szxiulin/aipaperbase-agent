...
def build_tools() -> list:
    ...
    return catalog_tools() + fulltext_tools() + exec_tools() + web_tools() + research_tools()


__all__ = ["build_tools", "catalog_tools", "fulltext_tools", "exec_tools", "web_tools", "research_tools"]
